    ...
    return (
        ...
        <>
            ...
            <header>
                ...
                <Container>
                    <Row>
                        <Col xs={12} md={6} sm={12} className='top-header1 text-sm-center text-md-start text-xs-center'>
                        ...
                        <Col xs={12} md={6} sm={12} md="auto" className='top-header2 text-sm-center text-md-start text-xs-center ms-auto'>
